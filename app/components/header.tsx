        ...
        <header>
            <nav className="w-full h-20 fixed bg-white shadow z-20 px-6 max-md:px-0">
                <div className="max-w-7xl mx-auto h-full flex justify-between items-center font-mono text-lg">
                    {/* Home Link */}
                    <Link
                        className="flex items-center gap-2 text-lg max-md:p-6"
                        href="/"
                    >
                        <FaHome size={20} />
                        Home
                    ...
                    <ul className="hidden md:flex gap-6">
                        ...
                        <li>
                            <Link href="/mozilla" className="hover:underline">
                                Mozilla
                            </Link>
                        </li>
                    </ul>
                ...
                {/* Mobile Menu */}
                {isOpen && (
                    <ul className="md:hidden mobile-nav flex flex-col gap-4  h-screen w-full py-4  shadow-md text-center font-mono text-lg">
                        <li>
                            <Link
                                href="/outlook"
                                onClick={toggleMenu}
