...
const Icons = () => {
    ...
    return(
        ...
        <button 
            ...
            >
            <label htmlFor="ms-outlook" className='text-lg underline '>Microsoft Outlook</label>
            <Image
                src={msOutlook}
                width={300}
                id='ms-outlook'
        ...
        <button 
                ...
                onClick={(() => router.push('/outlook'))}
            >
            <label htmlFor="ms-outlook" className='text-lg underline '>Google Mail</label>
            <Image
                src={googleMail}
                width={300}
                id='ms-outlook'
        ...
        <button 
                ...
                onClick={(() => router.push('/outlook'))}
            >
            <label htmlFor="ms-outlook" className='text-lg underline'>Mozilla Thunderbird</label>
            <Image
                src={mozilla}
                width={300}
                id='ms-outlook'
